...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "A general Package for any matching Tasks",
    Description = "...",
    `Authors@R` = c(
      person("Matthias", "Uckert", email = "Matthias.Uckert@Outlook.com", role = c("aut", "cre"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Matthias Uckert")
```
...
# Code of Conduct
usethis::use_code_of_conduct("Matthias.Uckert@Outlook.com")
# NEWS
usethis::use_news_md()
```
