...
# Datasets
```{r function-table_source, filename = "datasets"}
...
```{r function-table_target, filename = "datasets"}
...
```{r function-table_matches, filename = "datasets"}
...
fusen::inflate(flat_file = "dev/flat_datasets.Rmd", vignette_name = NA)
```
